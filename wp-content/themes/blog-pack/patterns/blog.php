 ...
 */
?>
<!-- wp:group {"tagName":"main","metadata":{"categories":["blogpage"],"patternName":"blog-pack/blog","name":"Blog"},"align":"full","style":{"dimensions":{"minHeight":"0px"}},"layout":{"type":"default"}} -->
<main class="wp-block-group alignfull" style="min-height:0px"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/archive-hero.jpg","dimRatio":0,"overlayColor":"contrast","isUserOverlayColor":true,"minHeight":330,"minHeightUnit":"px","contentPosition":"center center","align":"full","style":{"spacing":{"padding":{"top":"0px","bottom":"0rem"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover alignfull" style="padding-top:0px;padding-bottom:0rem;min-height:330px"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/archive-hero.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"wide","style":{"dimensions":{"minHeight":"0vh"},"spacing":{"padding":{"top":"0px","right":"0px","bottom":"50px","left":"0px"},"margin":{"top":"0px","bottom":"0px"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"left","verticalAlignment":"center"}} -->
...
<!-- wp:post-title {"isLink":true,"style":{"spacing":{"margin":{"bottom":"15px","top":"10px"}},"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"typography":{"fontSize":"1.77rem"}},"textColor":"black"} /-->
...
<figure class="wp-block-image aligncenter size-full is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/tyler.jpeg" alt="" style="border-radius:100px;width:124px;height:auto"/></figure>
<!-- /wp:image -->

<!-- wp:heading {"textAlign":"center","level":5,"style":{"spacing":{"padding":{"bottom":"0px"},"margin":{"top":"15px"}},"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"typography":{"textTransform":"none","letterSpacing":"1px","fontSize":"1.2rem"}},"textColor":"black"} -->
<h5 class="wp-block-heading has-text-align-center has-black-color has-text-color has-link-color" style="margin-top:15px;padding-bottom:0px;font-size:1.2rem;letter-spacing:1px;text-transform:none">Tyler Moore</h5>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:search {"label":"","placeholder":"Search blog...","buttonText":"Search","buttonPosition":"no-button","buttonUseIcon":true,"className":"is-style-high-search","style":{"border":{"radius":"33px"},"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"backgroundColor":"white","textColor":"black","borderColor":"vibrant"} /--></div>
<!-- /wp:group -->

<!-- wp:group {"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":5,"style":{"spacing":{"padding":{"bottom":"0px"},"margin":{"top":"15px"}},"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"typography":{"textTransform":"none","letterSpacing":"1px","fontSize":"1.2rem"}},"textColor":"black"} -->
<h5 class="wp-block-heading has-text-align-left has-black-color has-text-color has-link-color" style="margin-top:15px;padding-bottom:0px;font-size:1.2rem;letter-spacing:1px;text-transform:none">Must Read</h5>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:heading {"textAlign":"left","level":5,"style":{"spacing":{"padding":{"bottom":"0px"},"margin":{"top":"15px"}},"elements":{"link":{"color":{"text":"var:preset|color|black"}}},"typography":{"textTransform":"none","letterSpacing":"1px","fontSize":"1.2rem"}},"textColor":"black"} -->
<h5 class="wp-block-heading has-text-align-left has-black-color has-text-color has-link-color" style="margin-top:15px;padding-bottom:0px;font-size:1.2rem;letter-spacing:1px;text-transform:none">Categories</h5>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:image {"sizeSlug":"full","linkDestination":"custom","style":{"border":{"radius":"5px"}}} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/new-book.png" alt="" style="border-radius:5px"/></figure>
<!-- /wp:image -->
